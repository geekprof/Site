...
3.  **Le feedback immédiat** : L'élève peut soumettre son raisonnement et obtenir un retour instantané, lui permettant de s'auto-corriger en temps réel.

## Un exemple de prompt d'étayage

Pour transformer une IA en tuteur d'étayage, il est crucial de définir son rôle. Voici un exemple de structure :

> "Tu es un tuteur bienveillant. Ton objectif est d'aider l'élève à résoudre cet exercice de physique sans jamais lui donner la solution directe. Pose-lui une question à la fois pour le guider dans son raisonnement."

L'enjeu pour l'enseignant est désormais de former les élèves à interagir avec ces outils pour qu'ils deviennent de véritables leviers d'émancipation intellectuelle.
